function flattyShadow() {
    ...
    $('.flatty_shadow').each(function () {
        ...
        $(this).empty();
        $(this).append('<div class="flatty_icon"><span class="fs_icon">' +
            selectedIcon + '</span></div>')

        bg_color = ' rgba(' + hexToRgb(bg_color).r + ', ' + hexToRgb(bg_color).g + ', ' + hexToRgb(
            bg_color).b + ', ' + bg_transparency + ')';
        shadow_color = ' rgba(' + hexToRgb(shadow_color).r + ', ' + hexToRgb(shadow_color).g + ', ' +
            hexToRgb(shadow_color).b + ', ' + shadow_transparency + ')';
        icon_color = ' rgba(' + hexToRgb(icon_color).r + ', ' + hexToRgb(icon_color).g + ', ' +
            hexToRgb(icon_color).b + ', ' + icon_transparency + ')';
