...
(function () {
    ...
    aLi[4].onclick = function () {
        ...
        document.getElementById('start2').addEventListener(
            'click',
            function () {
                anim.start();
            },
        ...
        document.getElementById('stop2').addEventListener(
            'click',
            function () {
                anim.stop();
            },
...
/* demo-mark-19 */
(function () {
    let oDemo = document.querySelector('#content .demo19 .title');
    let aLi = document.querySelectorAll('#content .demo19 ul li');
    let konva = document.getElementById('konva19');
    var width = 800;
    var height = 500;
    ...
    aLi[0].onclick = function () {
        ...
        document.getElementById('activate1').addEventListener(
            'click',
            function () {
